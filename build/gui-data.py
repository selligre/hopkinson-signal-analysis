...
button_2 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: (window.destroy(), os.system("python ./build/gui-specimen.py")),
    relief="flat",
)
...
button_3 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: (print(c), app.import_data_file(c), print(c)),
    relief="flat",
)
...
button_4 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: (window.destroy(), os.system("python ./build/gui-analyze.py")),
    relief="flat",
)
